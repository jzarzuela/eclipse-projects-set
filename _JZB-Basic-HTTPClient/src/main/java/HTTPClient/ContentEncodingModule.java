...
class ContentEncodingModule implements HTTPClientModule
{
	...
	else if (encoding.equalsIgnoreCase("deflate"))
	{
        ...
        /* We need to add a dummy byte to the end of the stream, as
         * otherwise we get spurious EOFExceptions from zlib.
         */
        SequenceInputStream is =
        new SequenceInputStream(resp.inp_stream,
                    new ByteArrayInputStream(dummy));

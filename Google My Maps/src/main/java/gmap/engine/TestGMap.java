...
public class TestGMap {
    ...
    public void doIt(String[] args) throws Exception {
        ...
        GMapService srvc = new GMapService(false);
        ...
        //
        srvc.addMapFeatures(feature1, feature2, feature3);

        //
        feature1.setProperty("nombre", "nombre_1_1");
        feature1.setProperty("descripción", "desc_1_1");
        feature1.setProperty("icon", "icon_1_1");
        ...
        //
        srvc.updateMapFeatures(feature1, feature2, feature3);

        //
        srvc.deleteMapFeatures(feature1,feature2);
        
        /*
         * for (UserMapData userMapData : mapList) { try { Tracer._debug(""); Tracer._debug("Processing map: " + userMapData.getName() + " - id: " + userMapData.getId()); GMap map =
         * _getMapDataWithThrottleCheck(srvc, userMapData.getId()); map.toString(); } catch (Throwable th) { Tracer._error("** Error processing map: " + userMapData.getName() + " - Exc: " +
         * th.getClass().toString() + " / " + th.getMessage()); } }
         */

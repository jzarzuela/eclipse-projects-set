...
public class Surrogate {
    ...
    public static class Parser {
         ...
         * 
         * @returns Either a parsed UCS-4 character, in which case the isPair() and increment() methods will return meaningful values, or -1, in which case error() will return a descriptive result
         *          object
         */
    ...
    public static class Generator {
         ...
         * 
         * @returns Either a positive count of the number of UTF-16 characters written to the destination buffer, or -1, in which case error() will return a descriptive result object
         */
